...
image:https://circleci.com/gh/bombinating/jooq-gradle-plugin/tree/master.svg?style=svg["CircleCI", link="https://circleci.com/gh/bombinating/jooq-gradle-plugin/tree/master"]
