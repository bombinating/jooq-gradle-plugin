...
A https://gradle.org[Gradle] plugin for generating https://www.jooq.org/doc/3.11/manual/code-generation/codegen-configuration/[Java sources] for https://www.jooq.org[jOOQ] 3.11+ that works with the https://docs.gradle.org/current/userguide/kotlin_dsl.html[Gradle Kotlin DSL]

This is a Kotlin port of the Groovy-based https://github.com/etiennestuder/gradle-jooq-plugin[gradle-jooq-plugin]. This Kotlin version was developed because it was decided that the Groovy plugin https://github.com/etiennestuder/gradle-jooq-plugin/pull/91[would not add Kotlin DSL support].
...
----
plugins {
    id("dev.bombinating.jooq") version "0.0.4"
}
----
